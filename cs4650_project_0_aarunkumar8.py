# -*- coding: utf-8 -*-
"""CS4650_Project_0_aarunkumar8.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/12iX4IdJukCZCpigPz6zu8OZsiwl1uEUG
...
!wget https://raw.githubusercontent.com/cocoxu/CS4650_spring2025_projects/refs/heads/main/p0_data.txt
...
def gradient_descent(theta, X, y, alpha, max_iterations, print_iterations):
    ...
    ### If doing feature scaling (not required in this homework), this will be the place to do that too
    m_samples = X.shape[0]
    ...
    while(iteration < max_iterations):
        ...
        if iteration % print_iterations == 0 or iteration == 1:
            ...
            ### try "plt.plot(x_axis_range, (x_axis_range * 3 - 10), '-r')" for an example of line plot in solid red

            boundary_y = -(theta[0] + theta[1] * x_axis_range) / theta[2]
            plt.plot(x_axis_range, boundary_y, '-r')
